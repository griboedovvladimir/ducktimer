...
class ThemeSwitcher extends Component <IThemeSwitcherProps, any> {
    ...
    public componentDidMount(): void {
        this.props.switchTheme( storageService.getThemeFromLocalStorage() || 'b-n-w' );
        this.setState( {...this.state, switcher: !(storageService.getThemeFromLocalStorage() === 'b-n-w')} );
    }
    ...
    public render(): React.ReactNode {
        return (
            <div id="mode">
                <input onChange={this.switchHandle} className="checkbox" id="checkbox1" checked={this.state.switcher}
                       type="checkbox"/>
