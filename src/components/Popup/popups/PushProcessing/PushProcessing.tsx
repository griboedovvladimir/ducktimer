...
class PushProcessing extends Component<any, any> {
    render() {
        return (
            <div className="content">
                <p>
                    ...
                    recommended ASA by the factor in parenthesis (ie. If Tri-X rated
                    at 400ASA is normally developed for 6 mins in a standard soup,
                    then when Tri-X is pushed three stops to 3200ASA development would
                    be: 6 x 4.5 = 27 mins). Please use these recommendations as
                    starting points only. In many cases these times will prove
                    excessive, but when all else fails they can be a good guideline.
                    Please note separate data for Tmax films.
                </p>
                <br/>
                <dl>
